import { ClipboardBuiltinConfig } from "@/builtin-plugins/clipboard/config/ClipboardBuiltinConfig";
import type { BuiltinConfigPanel } from "@/builtin-plugins/settings/pages/config-types";
