/**
 * Portable HTML Structured Clone–style codec for the injected UI bridge.
 * Envelope: { "$sca": "<base64>" }
 */
(function (global) {
  "use strict";
  ...
  function scaEncode(value) {
    ...
    const bytes = utf8Encode(JSON.stringify({ root, table }));
  ...
  global.__tempoSca = {
    ...
    scaDecode,
    isScaEnvelope,
    scaEncodeArgs: (args) => scaEncode(args),
    scaDecodeArgs: (envelope) => {
