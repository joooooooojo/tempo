...
当前模板 2.0.6 使用 Manifest v2、Host API ^2.1.0，要求 Tempo >=2.2.6。后台运行于 Deno 2.9.6；Node/npm/TypeScript/Vite 仅用于构建，默认继续输出自包含 ESM `main.mjs`。

模板通过 `@tempo/sdk/ui` 和 `@tempo/sdk/runtime` 调用宿主 API。生成的项目会安装 SDK，Vite 将其打进最终插件产物。
